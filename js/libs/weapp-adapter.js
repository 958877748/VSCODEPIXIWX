			...
			var XMLHttpRequest = function () {
				...
				_createClass(XMLHttpRequest, [{
					...
					value: function send() {
						...
						if (this.readyState !== XMLHttpRequest.OPENED) {
						...
						} else if(_url.get(this).indexOf('//')==-1){
							let FSM = wx.getFileSystemManager()
							FSM.readFile({
								filePath:_url.get(this),
								encoding:'ascii',
								success:function success(par){
									data = par
									_this.status = 200
									_responseHeader.set(_this, '没有响应头')
							...
							wx.request({
								data: data,
								url: _url.get(this),//.indexOf('http')>-1?_url.get(this):location.origin+'/game/'+_url.get(this),
